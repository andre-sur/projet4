...
class TournamentView:
    ...
    def show_list_tournament(file_name):
        all_tournaments, last_one = TournamentModel.list_of_tournament(
            file_name)
        print("\n♙LISTE DES TOURNOIS")
        print(all_tournaments)
    
    def input_chosen_tournament():
    ...
    def matches_already_played(tournament,current_tournament):
    ...
    def main_menu():
        ...
        while choice not in ["1","2","3"]:
            ...
            if choice =="2":
                TournamentView.choose_tournament(file_name="tournament_data.json")
            if choice =="3":
                exit()
    ...
    def input_data_tournament(current_tournament, tournament):
        ...
        TournamentView.save_basic_datas(input_data,tournament)
        return input_data

    def save_basic_datas (input_data,tournament):
